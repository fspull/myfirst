...
# Model Parameters
ARCHITECTURE = 'Unet'
ENCODER = 'mit_b5' #timm-regnety_016
ENCODER_WEIGHT= 'imagenet' #imagenet
N_CLASSES = 1
ACTIVATION = None
OPTIMIZER = 'AdamW'
# 모델 및 백본 변경시 수정 필요.
SAVED_MODEL_PATH = '/root/jupyter/Dacon/deeplabv3p/model_save_unet_mitb5_#2/'
...
for epoch in range(START_EPOCH, START_EPOCH+NUM_EPOCH):
    ...
    path = SAVED_MODEL_PATH + 'unet-mit_b5-aslLoss-{num:0004d}.pth'.format(num=epoch)
...
# !!!!파일명 변경 필요!!!!
loss_df.to_csv(path_or_buf=LOSS_PATH + 'unet-mit_b5-aslLoss_#2.csv' , 
               index=False,
